...
export const reviews = pgTable(
  ...
  (table) => {
    return [{
      userIdBookIdUnique: uniqueIndex('reviews_user_id_book_id_unique_idx').on(
        table.userId,
        table.bookId
      ), // If a user can review a book only once
...
export const bookEntries = pgTable(
  ...
  (table) => {
    return [{
      ...
      userBookShelfUnique: uniqueIndex('book_entries_user_id_book_id_shelf_id_unique_idx').on(
        table.userId,
        table.bookId,
        table.shelfId
      ),
...
export const sellerListings = pgTable('seller_listings', {
  ...
  price: real('price'),
  currency: text('currency'), // e.g., "USD", "RUB"
  availability: text('availability'), // e.g., "In Stock", "Check Website"
