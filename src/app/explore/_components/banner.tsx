  ...
  return (
    <section className="my-12">
      <div className="relative overflow-hidden rounded-xl shadow-lg">
        <div className="h-64 w-full bg-neutral-200 md:h-96 dark:bg-neutral-700">
          <img
            src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&h=600"
            alt="Book collection"
            className="h-full w-full object-cover"
          />
          <div className="from-accent/80 absolute inset-0 flex items-center bg-gradient-to-r to-transparent">
